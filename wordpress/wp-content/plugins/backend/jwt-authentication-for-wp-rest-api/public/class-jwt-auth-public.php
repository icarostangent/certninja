...
class Jwt_Auth_Public
{
    ...
    public function generate_token($request)
    {
        ...
        $data = array(
            ...
            'account' => unserialize(get_user_meta($user->ID, 'account', true))
        );
    ...
    public function determine_current_user($user)
    {
        ...
        /*
         * if the request URI is for a backend/v1/user endpoint don't do anything
         */
        $validate_uri = strpos($_SERVER['REQUEST_URI'], 'backend/v1/user');
        if ($validate_uri > 0) {
            return $user;
        }

        /*
         * if the request URI is for a wp/v2/menu-items endpoint don't do anything
         */
        // $validate_uri = strpos($_SERVER['REQUEST_URI'], 'wp/v2/menu-items');
        // if ($validate_uri > 0) {
        //     return $user;
        // }

        /*
         * if the request URI is for a wp/v2/pages endpoint don't do anything
         */
        $validate_uri = strpos($_SERVER['REQUEST_URI'], 'wp/v2/pages');
        if ($validate_uri > 0) {
            return $user;
        }

        /*
         * if the request URI is for a wp/v2/posts endpoint don't do anything
         */
        $validate_uri = strpos($_SERVER['REQUEST_URI'], 'wp/v2/posts');
        if ($validate_uri > 0) {
            return $user;
        }

        /*
         * if the request URI is for a WooCommerce v3 endpoint don't do anything
         */
        // $validate_uri = strpos($_SERVER['REQUEST_URI'], 'wc/v3');
        // if ($validate_uri > 0) {
        //     return $user;
        // }
